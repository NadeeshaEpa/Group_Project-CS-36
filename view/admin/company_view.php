...
>>>>>>> 4ebb61c105054ab64a2024b5559971ff371e8458
    ...
    <?php 
                   if(isset($_SESSION['view_company'])){
                      $result=$_SESSION['view_company']; 
                    //   $names=$result[1];
                   }
                ?>
    <form action="../../controller/admin/company_controller.php" method="POST" id="company_form">
	     
    <div class="data">
    <h2>Gas Company Details</h2><br>
...
>>>>>>> 4ebb61c105054ab64a2024b5559971ff371e8458
        ...
        <div class="down">
             <div class="down1">  
                ...
                <input type="text" name="company_id" value=<?php echo $result[0]['company_id']; ?> ><br>
			</div>

            <div class="down1">  
		        <label>Company Name :</label><br>  
                <input type="text" name="company_name" value=<?php echo $result[0]['company_name']; ?> readonly><br> 
		     </div>
		</div>
