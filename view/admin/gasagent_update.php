...
<body>
    ...
    <?php 
                ...
                ?>
    <form action="../../controller/admin/gasagentacc_controller.php" method="POST" id="staff_form">
    ...
    <div class="down"> 
        ...
        <br><br>
		<div class="down"> 
        <a href="../../view/admin/admin-viewGasagent.php"><button style="background-color: #da3a3a;" class="b4">Cancel</button></a> 
