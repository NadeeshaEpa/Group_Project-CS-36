...
<body>
	...
	<div class="down">
	   <div class="down1">
        ...
        <input type="text" name="company_id" id="company_id" value="<?php echo $result[0]['company_id']?>"   required readonly>
       </div>
       <div class="down1">
	    <label>Company Name:</label>
          <input type="text" name="company_name" id="company_name" value="<?php echo $result[0]['company_name']?>" placeholder="Company Name"  required>
		</div>
	</div>
