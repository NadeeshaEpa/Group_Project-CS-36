...
<div class="registration-form">
    ...
    <form action="../../controller/staff/cylinder_controller.php" method="POST" id="staff_form" enctype="multipart/form-data">
        <h2>Update Gas Cylinder Information</h2>
        Cylinder ID : 
        <input type="text" name="Cylinder_Id" id="name"  value="<?php echo $result[0]['Cylinder_Id']?>"  required readonly><br><br>

		Gas Company :
          <input type="text" name="company" id="name"  value="<?php echo $result[0]['company_name']?>"  required readonly><br><br>
