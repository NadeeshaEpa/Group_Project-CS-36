...
<body>
   ...
   <div class="up">
		...
		<div class="down"> 
		 ...
		 <button onclick="acceptrequest(<?php echo $result[0]['Customer_Id']; ?>);" class="b2">Accept</button>  
		<button onclick="deleterequest(<?php echo $result[0]['Customer_Id']; ?>);" class="b4">Decline</button>
        <br>
		</div>
    <!-- </form> -->
    </div>
    ...
    <script>
		function deleterequest(id){
            ...
            document.getElementById("yes").addEventListener("click",function(){
                window.location.href="../../controller/staff/customeracc_controller.php?deid="+id;
            });
	...
	<script>
		function acceptrequest(id){
            ...
            document.getElementById("yes1").addEventListener("click",function(){
                window.location.href="../../controller/staff/customeracc_controller.php?aid="+id;
            });
