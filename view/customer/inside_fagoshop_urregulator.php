...
<body>
    ...
    <?php 
            if(isset($_SESSION['unregulator_page'])){
                $page=$_SESSION['unregulator_page'];
            }else{
                $page=1;
            }
            if(isset($_SESSION['unregulator_total_pages'])){
                $total_pages=$_SESSION['unregulator_total_pages'];
            }else{
                $total_pages=1;
            }    
        ?>
            ...
            <?php if($page>1){?>
                ...
                <div class="p-left">
                    <form action="../../controller/customer/shop_controller.php" method="GET">
                        <input type="hidden" name="unregulator_page" value="<?php echo $page-1?>">
