...
<body>
    ...
    <div class="serach-bar">
        <form method="get" action="../../controller/customer/shop_controller.php">
            ...
            <button type="submit" name="rsearch">Search</button>
        </form>
    </div>  
    <div class="products">
        <?php
        ...
        <?php 
            if(isset($_SESSION['regulator_page'])){
                $page=$_SESSION['regulator_page'];
            }else{
                $page=1;
            }
            if(isset($_SESSION['regulator_total_pages'])){
                $total_pages=$_SESSION['regulator_total_pages'];
            }else{
                $total_pages=1;
            }    
        ?>
            ...
            <?php if($page>1){?>
                ...
                <div class="p-left">
                    <form action="../../controller/customer/shop_controller.php" method="GET">
                        <input type="hidden" name="regulator_page" value="<?php echo $page-1?>">
