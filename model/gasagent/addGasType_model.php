...
class add_gasType{
    ...
    public function setDetails($gasType='',$weight='',$quantity=''){
    ...
    public function GasPublish($connection){
        ...
        if(isset($row)){
            ...
            $sql="INSERT INTO sell_gas (GasAgent_Id, Cylinder_Id, Quantity) VALUES ('$this->GasagentId','$this->GasTypeId','$this->Quantity')";
