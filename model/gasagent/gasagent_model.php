...
class gasagent_model{
    ...
    public function setDetails($firstname='',$lastname='',$username='',$street='',$city='',$postalcode='',$password='',$email='', $contactnumber='',$business_reg_num='',$shopnumber='',$nic='',$accountnum=''){
    ...
    public function setgasagent($connection){
        $sql="INSERT INTO gasagent(GasAgent_Id,NIC,Account_No,NextArrival_Date,BusinessReg_No,Staff_Id,Registration_date,Status) VALUES ('$this->User_id','$this->nic','$this->accountno',NULL,'$this->business_reg_num',NULL,NULL,'0')";
        if($connection->query($sql)){
