...
require_once '../../model/fuelmanager/fuelmanagerforgotpassword_model.php';
require_once '../../model/fuelmanager/fuelManager_model.php';
require_once '../../model/fuelmanager/checkFuelManager_model.php';
...
class forgotpassword_controller{
    ...
    public function sendEmail($connection){
        ...
        if(empty($useremail)){
            ...
            header("Location: ../../view/fuelmanager/forgot_password.php");
            exit();
    ...
    public function resetPassword($connection){
            ...
            $url='../../view/fuelmanager/createnewpassword.php?selector='.$data['selector'].'&validator='.$data['validator'];
            ...
            if(empty($_POST['password'])|| empty($_POST['cpassword'])){
                ...
                $result4=checkFuelManagerEmail($tokenEmail,$connection);
                if(!$result4){
                ...
                $result5=$this->user->updatePassword($connection,$newpwd,$tokenEmail);
                if(!$result5){
                    $_SESSION['password-status']="There was an error";
                    header("Location: ".$url);
                }
