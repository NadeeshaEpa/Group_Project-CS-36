...
require_once '../../model/staff/forgotpassword_model.php';
...
class forgotpassword_controller{
    ...
    public function sendEmail($connection){
        ...
        if(empty($useremail)){
            ...
            header("Location: ../../view/staff/forgot_password.php");
            exit();
        ...
        $url="http://localhost/Fago/view/staff/createnewpassword.php?selector=".$selector."&validator=".bin2hex($token);
        $expires=date("U")+1800;
