...
include_once '../../model/admin/gasagent_model.php';
...
if(isset($_GET['did'])){
    ...
    if($result===false){
        ...
        if($result){
            $_SESSION['gasagentdetails']=$result;
            header("Location:../../controller/admin/gasagentacc_controller.php?id=viewGasagent");
        }else{
            header("Location:../../view/admin/admin-viewGasagent.php");
        }
    }
...
if(isset($_GET['uid'])){
    ...
    if($result===false){
        ...
        header("Location: ../../view/admin/gasagent_update.php");
    }
}
