...
require_once("../../model/admin/profile_model.php");
require_once("../../model/admin/checkadmin_model.php");
...
if(isset($_POST['changepassword'])){
    if(isset($_SESSION['User_id'])){ 
        header("Location: ../../view/admin/admin_changepassword.php");
    }
}
    ...
    if(in_array($fileActualExt,$allowed)){
        if($fileError === 0){
            if($fileSize < 10000000){
                ...
                $fileDestination='../../public/images/admin/profile_img/'.$fileNameNew;
...
if(isset($_POST['removeimg'])){
    ...
    if($result){
        ...
        header("Location: ../../view/admin/profile.php.php");
    }else{
